...
[2/5] Downloading the package
      crow-0.0.6-win-x64.zip  [####################.....]  84%  424.1 MB / 506.4 MB  18.2 MB/s
...
```
crow 0.0.7 is out (you have 0.0.6)
  irm https://raw.githubusercontent.com/nibor1896/Crow/main/install.ps1 | iex
```
...
**Crow acts now.** Since 0.0.5 a reply can become an action: the client executes the call, hands the result back and asks again, up to 24 rounds — `--max-tool-rounds` moves that, and a turn that runs out answers from what it has instead of stopping. That was [#55](https://github.com/nibor1896/Crow/issues/55), and it changes what the remaining list is about.
